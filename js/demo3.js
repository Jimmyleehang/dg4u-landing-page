        ...
        createFrame() {
            ...
            this.DOM.svg.innerHTML = `
                ...
                <linearGradient id="gradient1" x1="0%" y1="0%" x2="0%" y2="100%">
                    <stop offset="0%" stop-color="#E66432">
                        <!--animate attributeName="stop-color" values="#E66432; #FFEDBC; #ED4264" dur="3s" repeatCount="indefinite"></animate-->
                    </stop>
                    <stop offset="100%" stop-color="#FFEDBC">
                        <!--animate attributeName="stop-color" values="#FFEDBC; #E66432; #FFEDBC" dur="3s" repeatCount="indefinite"></animate-->
                    </stop>
                </linearGradient>
                </defs>
